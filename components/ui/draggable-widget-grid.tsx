	...
	return (
		<motion.div
			...
			<motion.div
				...
				className={`relative isolate flex h-full w-full flex-col overflow-hidden rounded-[var(--widget-radius)] bg-card text-card-foreground transition-shadow duration-300 [clip-path:inset(0_round_var(--widget-radius))] ${
					landed ? 'ring-2 ring-foreground/40' : 'border border-gray-100 shadow-sm'
				}`}>
